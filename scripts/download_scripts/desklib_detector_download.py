#!/usr/bin/env python3
"""Download desklib/ai-text-detector-v1.01 to the local models directory."""
...
DEFAULT_OUTPUT_DIR = PROJECT_ROOT / "models" / "desklib-ai-text-detector-v1.01"
REQUIRED_FILES = [
    "added_tokens.json",
    "config.json",
    "model.safetensors",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Download Desklib AI detector files.")
    parser.add_argument(
        "--model-id",
